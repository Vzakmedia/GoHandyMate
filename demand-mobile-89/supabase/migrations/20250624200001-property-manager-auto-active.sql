...
-- Update the handle_new_user function to set property managers as active by default
...
-- Update existing property manager accounts to be active
UPDATE public.profiles 
SET account_status = 'active'::account_status_enum
WHERE user_role = 'property_manager' AND account_status = 'pending'::account_status_enum;
