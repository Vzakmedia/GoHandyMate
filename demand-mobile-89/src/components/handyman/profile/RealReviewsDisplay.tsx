...
interface RealReviewsDisplayProps {
  providerId: string;
}

export const RealReviewsDisplay = ({ providerId }: RealReviewsDisplayProps) => {
        ...
        {totalReviews === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-400">
              Complete your first job to start receiving customer reviews
            </p>
          </div>
        )}
      </CardContent>
