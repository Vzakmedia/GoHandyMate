...
-- Add missing columns for location tracking functionality

-- Add is_real_time column to handyman_locations table
ALTER TABLE public.handyman_locations 
ADD COLUMN IF NOT EXISTS is_real_time boolean DEFAULT false;

-- Add session_started column to handyman_locations table  
ALTER TABLE public.handyman_locations 
...
-- Create function to find nearby handymen if it doesn't exist
